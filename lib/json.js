...
module.exports = {
	...
	reset_modules : (callback) => {
		status.abg.ready  = false;
		status.abg.reset  = true;
		status.anzv.ready = false;
		status.anzv.reset = true;
		status.bmbt.ready = false;
		status.bmbt.reset = true;
		status.ccm.ready  = false;
		status.ccm.reset  = true;
		...
		status.ews.ready  = false;
		status.ews.reset  = true;
		status.gm.ready   = false;
		status.gm.reset   = true;
		status.gt.ready   = false;
		status.gt.reset   = true;
		status.hac.ready  = false;
		status.hac.reset  = true;
		status.ihka.ready = false;
		status.ihka.reset = true;
		status.ike.ready  = false;
		status.ike.reset  = true;
		status.lcm.ready  = false;
		status.lcm.reset  = true;
		status.mfl.ready  = false;
		status.mfl.reset  = true;
		status.mid.ready  = false;
		status.mid.reset  = true;
		status.nav.ready  = false;
		status.nav.reset  = true;
		status.pdc.ready  = false;
		status.pdc.reset  = true;
		status.rad.ready  = false;
		status.rad.reset  = true;
		status.rls.ready  = false;
		status.rls.reset  = true;
		status.ses.ready  = false;
		status.ses.reset  = true;
		status.shd.ready  = false;
		status.shd.reset  = true;
		status.tel.ready  = false;
		status.tel.reset  = true;
		status.vid.ready  = false;
		status.vid.reset  = true;
