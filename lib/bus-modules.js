...
var bus_modules = function() {
	hex2name = this.hex2name;
	modules  = this.modules;
	name2hex = this.name2hex;
}

bus_modules.prototype.modules = {
	ABG  : 0xA4, // Airbag
...
// 0x80 -> IKE
bus_modules.prototype.hex2name = function(hex) {
...
// IKE -> 0x80
bus_modules.prototype.name2hex = function(name) {
